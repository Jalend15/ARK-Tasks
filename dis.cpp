...
Mat w1,w2,result;
 ...
 int a=0;
 long int min1;
 int point_count = img1.rows*img1.cols;
...
vector<Point2f> points2(point_count);
 ...
 Mat H1(img1.rows,img2.cols,img1.type());
 Mat H2(img1.rows,img1.cols,img2.type());
 bool stereoRectifyUncalibrated( points1, points2, F, img1.size(), H1, H2, 5 );
 //Mat rectified1(img1.size(), image1.type());
 warpPerspective(img1, img1, H1, img1.size());
 warpPerspective(img2, img2, H1, img1.size());
